...
public class NM3DFractalImageCompression {
    
    public static void main(String[] args) throws IOException {
        
        File brainFile = new File("/resources/brainNew.rawb");
        File fractalFile = new File("/resources/brainas.txt");

        NM3DImage image3d = new NM3DImage(brainFile);

        NM2DImage sliceImage = new NM2DImage(image3d.side, image3d.side);
        String path = "/resources/image/originalC";
        File fs;
        ...
        NM3DImage domainBlock = new NM3DImage(Global.DB_SIDE);
        NM3DImage rangeBlock = new NM3DImage(Global.DB_SIDE);
        NM3DImage flippedRangeBlock = new NM3DImage(Global.DB_SIDE);

//      NM3DImage smallImage = new NM3DImage(image3d.side/2);
//      NM3DImage smallImage1 = new NM3DImage(smallImage.side/2);
        ...
        //MyImage3D asdf = new NM3DImage(image3d.side);
